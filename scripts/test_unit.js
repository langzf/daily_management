...
const { normalizeBaseUrl, isValidUserId, isValidBaseUrl, normalizeSnapshotData } = require('../utils/sync');
...
assert.strictEqual(isValidUserId('demo_user-1'), true);
assert.strictEqual(isValidUserId('bad user'), false);
